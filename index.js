...
io.on('connection', function(socket) {
	console.log("connection");
  	socket.on('client_runningSim', function(data) {
     	io.emit("serverResponse", "cell " + data + " is simming");
   	});
   	socket.on('enemyCellChange', function(data) {
     	io.emit("enemyCellChange", data);
   	});
});
